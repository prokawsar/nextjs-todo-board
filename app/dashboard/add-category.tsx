        ...
        <div className="flex flex-col">
          <form onSubmit={(e) => onSubmit(e)}>
            ...
            <div className="flex flex-row items-center justify-between gap-3">
              <button
                type="submit"
                className="my-1 bg-purple-400 hover:bg-purple-600 text-white border border-blue-700 px-3 rounded-md"
              >
                Add
              </button>
              <button
                type="button"
                className="bg-slate-200 p-1 hover:bg-slate-400 hover:text-white rounded-full h-6 w-6 flex justify-center items-center"
